...
void __fastcall TOptionDlg::FormCreate(TObject *Sender)
{
	...
	SndWarnEdit->Tag			= (NativeInt)&SoundWarning;
	SndTaskFinEdit->Tag 		= (NativeInt)&SoundTaskFin;
	SndFindFinEdit->Tag 		= (NativeInt)&SoundFindFin;
	SndWatchEdit->Tag			= (NativeInt)&SoundWatch;
	DirDelimiterEdit->Tag		= (NativeInt)&DirDelimiter;
	DirBraEdit->Tag 			= (NativeInt)&DirBraStr;
	DirKetEdit->Tag 			= (NativeInt)&DirKetStr;
	DrvInfFmtREdit->Tag 		= (NativeInt)&DrvInfFmtR;
	DrvInfFmtSEdit->Tag 		= (NativeInt)&DrvInfFmtS;
	DrvInfFmtNEdit->Tag 		= (NativeInt)&DrvInfFmtN;
	SttBarFmtEdit->Tag			= (NativeInt)&SttBarFmt;
	ClockFmtEdit->Tag			= (NativeInt)&SttClockFmt;
	TmStampFmtEdit->Tag 		= (NativeInt)&TimeStampFmt;
	ViewTab4Edit->Tag			= (NativeInt)&FExtViewTab4;
	ViewTabXEdit->Tag			= (NativeInt)&FExtViewTabX;
	TabXWdEdit->Tag				= (NativeInt)&ViewTabWidthX;
	EmpBin1Edit->Tag			= (NativeInt)&EmpBinPtn1;
	EmpBin2Edit->Tag			= (NativeInt)&EmpBinPtn2;
	EmpBin3Edit->Tag			= (NativeInt)&EmpBinPtn3;
	InsHrClsEdit->Tag			= (NativeInt)&HtmInsHrCls;
	...
	NoInfPathEdit->Tag			= (NativeInt)&NoInfPath;
	NoImgPrvPathEdit->Tag		= (NativeInt)&NoImgPrvPath;
	FExtImgPrvEdit->Tag 		= (NativeInt)&FExtImgPrv;
	FExtNoImgPrvEdit->Tag		= (NativeInt)&FExtNoImgPrv;
	FExtNoIViewEdit->Tag		= (NativeInt)&FExtNoIView;
	NoCachePathEdit->Tag		= (NativeInt)&NoCachePath;
	MarkPathEdit->Tag			= (NativeInt)&MarkImgPath;
	MarkFextEdit->Tag			= (NativeInt)&MarkImgFExt;
	...
	HomeWorkListEdit->Tag		= (NativeInt)&HomeWorkList;
	WebSeaUrlEdit->Tag			= (NativeInt)&WebSeaUrl;
	BgImg1Edit->Tag				= (NativeInt)&BgImgName[0];
	BgImg2Edit->Tag				= (NativeInt)&BgImgName[1];
	SpImgEdit->Tag				= (NativeInt)&BgImgName[2];
	SpImg2Edit->Tag				= (NativeInt)&BgImgName[3];
	KnobImgEdit->Tag			= (NativeInt)&BgImgName[4];
	TimerCnd1Edit->Tag			= (NativeInt)&Timer_Condition[0];
	TimerCmd1Edit->Tag			= (NativeInt)&OnTimerEvent[0];
	TimerCnd2Edit->Tag			= (NativeInt)&Timer_Condition[1];
	TimerCmd2Edit->Tag			= (NativeInt)&OnTimerEvent[1];

	//int (NumbersOnly = true)
	BatLowLimitEdit->Tag		= (NativeInt)&BatLowerLimit;
	MaxLogLinesEdit->Tag		= (NativeInt)&MaxLogLines;
	MaxLogFilesEdit->Tag		= (NativeInt)&MaxLogFiles;
	FwCntWarnEdit->Tag			= (NativeInt)&FlashCntWarning;
	FwTmWarnEdit->Tag			= (NativeInt)&FlashTimeWarning;
	FwCntTaskFinEdit->Tag		= (NativeInt)&FlashCntTaskfin;
	FwTmTaskFinEdit->Tag		= (NativeInt)&FlashTimeTaskfin;
	NotifyTaskTimeEdit->Tag		= (NativeInt)&NotifyTaskTime;
	FrmMgnEdit->Tag				= (NativeInt)&ImgFrameMargin;
	FitMaxZoomEdit->Tag			= (NativeInt)&ImgFitMaxZoom;
	MinShowTimeEdit->Tag		= (NativeInt)&MinShowTime;
	MsgHintTimeEdit->Tag		= (NativeInt)&MsgHintTime;
	KeyHintTimeEdit->Tag		= (NativeInt)&KeyHintTime;
	ImgGridHEdit->Tag			= (NativeInt)&ImgGridHorzN;
	ImgGridVEdit->Tag			= (NativeInt)&ImgGridVertN;
	ThumbSizeEdit->Tag	 		= (NativeInt)&ThumbnailSize;
	ThumbBdrEdit->Tag			= (NativeInt)&ThumbBdrWidth;
	IntrPgEdit->Tag				= (NativeInt)&ImgDblMargin;
	BdrMovWdLabeledEdit->Tag	= (NativeInt)&BorderMoveWidth;
	ListInterLnEdit->Tag		= (NativeInt)&ListInterLn;
	CursorWidthEdit->Tag		= (NativeInt)&CursorWidth;
	CursorAlphaEdit->Tag		= (NativeInt)&CursorAlpha;
	FExtMaxWidthEdit->Tag		= (NativeInt)&FExtMaxWidth;
	ListPercentEdit->Tag		= (NativeInt)&ListPercent;
	TabWidthEdit->Tag			= (NativeInt)&FlTabWidth;
	TextInterLnEdit->Tag		= (NativeInt)&ViewTxtInterLn;
	LeftMarginEdit->Tag 		= (NativeInt)&ViewLeftMargin;
	FoldWdEdit->Tag 			= (NativeInt)&ViewFoldWidth;
	FixedLimitEdit->Tag			= (NativeInt)&ViewFixedLimit;
	CellAlphaEdit->Tag			= (NativeInt)&CellAlpha;
	ViewWheelScrLnEdit->Tag 	= (NativeInt)&ViewWheelScrLn;
	ListWheelScrLnEdit->Tag 	= (NativeInt)&ListWheelScrLn;
	PrvTxtInfLnEdit->Tag		= (NativeInt)&PrvTxtInfLn;
	PrvTxtTailLnEdit->Tag		= (NativeInt)&PrvTxtTailLn;
	...
	DlgMoveEdit->Tag			= (NativeInt)&DlgMovePrm;
	DlgSizeEdit->Tag			= (NativeInt)&DlgSizePrm;
	CmpDelOwCntEdit->Tag		= (NativeInt)&CmpDelOwCnt;
	MigemoMinEdit->Tag			= (NativeInt)&IncSeaMigemoMin;
	ToleranceEdit->Tag 			= (NativeInt)&TimeTolerance;
	RemoteWaitTimeEdit->Tag 	= (NativeInt)&RemoteWaitTime;
	NormalWaitTimeEdit->Tag 	= (NativeInt)&NormalWaitTime;
	NopDtctTimeEdit->Tag		= (NativeInt)&NopDtctTime;
	MaxDirHistEdit->Tag 		= (NativeInt)&MaxDirHistory;
	ModalAlphaEdit->Tag 		= (NativeInt)&ModalScrAlpha;
	BgColAlphaEdit->Tag 		= (NativeInt)&BgColAlpha;
	HideTimeEdit->Tag			= (NativeInt)&BgHideTime;
	TileIfSzEdit->Tag			= (NativeInt)&BgTileSize;
	SplitWidthEdit->Tag 		= (NativeInt)&SplitterWidth;
	SplitWidth2Edit->Tag		= (NativeInt)&SplitterWidth2;
	IconCacheEdit->Tag			= (NativeInt)&IconCache;
	FindPathWdEdit->Tag 		= (NativeInt)&FindPathWidth;
	FindTagsWdEdit->Tag 		= (NativeInt)&FindTagsWidth;

	//bool
	DivFlistUDCheckBox->Tag 	= (NativeInt)&DivFileListUD;
	DivDirInfUDCheckBox->Tag	= (NativeInt)&DivDirInfUD;
	HideAtrCheckBox->Tag		= (NativeInt)&ShowHideAtr;
	SysAtrCheckBox->Tag 		= (NativeInt)&ShowSystemAtr;
	DispRegNameCheckBox->Tag	= (NativeInt)&DispRegName;
	UncToNetDriveCheckBox->Tag	= (NativeInt)&UncToNetDrive;
	CompInTitleBarCheckBox->Tag = (NativeInt)&CompInTitleBar;
	TabGrInTitleBarCheckBox->Tag= (NativeInt)&TabGrInTitleBar;
	PathInTitleBarCheckBox->Tag = (NativeInt)&PathInTitleBar;
	UseIndIconCheckBox->Tag 	= (NativeInt)&UseIndIcon;
	OmitEndOfNameCheckBox->Tag	= (NativeInt)&OmitEndOfName;
	ShowAdsInfCheckBox->Tag		= (NativeInt)&ShowAdsInf;
	ShowProcInfCheckBox->Tag	= (NativeInt)&ShowUseProcInf;
	DirJumboCheckBox->Tag		= (NativeInt)&ShowDirJumboIco;
	InZipImgCheckBox->Tag		= (NativeInt)&ShowInZipImg;
	AniGifCheckBox->Tag 		= (NativeInt)&PreviewAniGif;
	SetCursorCheckBox->Tag 		= (NativeInt)&SetPrvCursor;
	PrevTxtToInfCheckBox->Tag	= (NativeInt)&ShowTextPreview;
	PrevTailCheckBox->Tag		= (NativeInt)&ShowTailPreview;
	ViewArcInfCheckBox->Tag 	= (NativeInt)&ViewArcInf;
	CheckTSCheckBox->Tag 		= (NativeInt)&CheckTS;
	ReloadActCheckBox->Tag		= (NativeInt)&ReloadOnActive;
	OpenAddDrvCheckBox->Tag 	= (NativeInt)&OpenAddedDrive;
	CheckUncCheckBox->Tag		= (NativeInt)&CheckUnc;
	ForceDelCheckBox->Tag		= (NativeInt)&ForceDel;
	RemoveCdRoCheckBox->Tag 	= (NativeInt)&RemoveCdReadOnly;
	CopyTagsCheckBox->Tag		= (NativeInt)&CopyTags;
	CopyNoBuffCheckBox->Tag 	= (NativeInt)&CopyNoBuffering;
	ShowArcCopyPrgCheckBox->Tag = (NativeInt)&ShowArcCopyProg;
	DelUseTrsCheckBox->Tag		= (NativeInt)&DelUseTrash;
	SyncItemCheckBox->Tag		= (NativeInt)&SyncItem;
	NotShowNoTaskCheckBox->Tag	= (NativeInt)&NotShowNoTask;
	ShowMsgHintCheckBox->Tag	= (NativeInt)&ShowMsgHint;
	ShowKeyHintCheckBox->Tag	= (NativeInt)&ShowKeyHint;
	ShowNoKeyHintCheckBox->Tag	= (NativeInt)&ShowNoKeyHint;
	ShowCopyHintCheckBox->Tag	= (NativeInt)&ShowCopyHint;
	ShowDuplNotifyCheckBox->Tag = (NativeInt)&ShowDuplNotify;
	ShowTooltipCheckBox->Tag	= (NativeInt)&ShowTooltip;
	LogErrOnlyCheckBox->Tag 	= (NativeInt)&LogErrOnly;
	LogErrMsgCheckBox->Tag		= (NativeInt)&LogErrMsg;
	LogDebugInfCheckBox->Tag	= (NativeInt)&LogDebugInf;
	LogHideSkipCheckBox->Tag	= (NativeInt)&LogHideSkip;
	LogFullPathCheckBox->Tag	= (NativeInt)&LogFullPath;
	LogDestinationCheckBox->Tag	= (NativeInt)&LogDestination;
	SaveLogCheckBox->Tag		= (NativeInt)&SaveLog;
	AppendLogCheckBox->Tag		= (NativeInt)&AppendLog;
	NotSortWLCheckBox->Tag		= (NativeInt)&NotSortWorkList;
	RegWkCsrPosCheckBox->Tag	= (NativeInt)&RegWorkCsrPos;
	AutoDelWLCheckBox->Tag		= (NativeInt)&AutoDelWorkList;
	NoChkWUncCheckBox->Tag		= (NativeInt)&NoCheckWorkUnc;
	AddToRecentCheckBox->Tag	= (NativeInt)&AddToRecent;
	NoChkRUncCheckBox->Tag		= (NativeInt)&NoCheckRecentUnc;
	DirHistCsrPosCheckBox->Tag	= (NativeInt)&DirHistCsrPos;
	DirHistSrotMdCheckBox->Tag	= (NativeInt)&DirHistSortMode;
	DelDplDirHistCheckBox->Tag	= (NativeInt)&DelDplDirHist;
	WorkToDirHistCheckBox->Tag	= (NativeInt)&WorkToDirHist;
	NoChkDirHistCheckBox->Tag	= (NativeInt)&NoCheckDirHist;
	ExtSavDirHistCheckBox->Tag	= (NativeInt)&ExtSaveDirHist;
	...
	DotPerUserCheckBox->Tag 	= (NativeInt)&DotNyanPerUser;
	SelByMouseCheckBox->Tag 	= (NativeInt)&SelectByMouse;
	SelBaseOnlyCheckBox->Tag	= (NativeInt)&SelectBaseOnly;
	SelIconCheckBox->Tag		= (NativeInt)&SelectIconSngl;
	...
	InactGrayCheckBox->Tag		= (NativeInt)&InactiveGray;
	...
	ShowTargetInfCheckBox->Tag	= (NativeInt)&ShowTargetInf;
	ShowImgPrvCheckBox->Tag 	= (NativeInt)&ShowImgPreview;
	ShowFilePropCheckBox->Tag	= (NativeInt)&ShowProperty;
	HideScrBarCheckBox->Tag 	= (NativeInt)&HideScrBar;
	ShowHeaderCheckBox->Tag 	= (NativeInt)&ShowHeader;
	FixListCheckBox->Tag		= (NativeInt)&FixListWidth;
	KeepOnResizeCheckBox->Tag	= (NativeInt)&KeepOnResize;
	KeepCurListWdCheckBox->Tag	= (NativeInt)&KeepCurListWidth;
	NoSpcFExtCheckBox->Tag		= (NativeInt)&NoSpaceFExt;
	ShowClsTabBtnCheckBox->Tag	= (NativeInt)&ShowClsTabBtn;
	ShowPopTabBtnCheckBox->Tag	= (NativeInt)&ShowPopTabBtn;
	ShowMainMenuCheckBox->Tag	= (NativeInt)&ShowMainMenu;
	HideTitMenuCheckBox->Tag	= (NativeInt)&HideTitleMenu;
	GrayScaleCheckBox->Tag		= (NativeInt)&BgImgGray;
	HideScrCheckBox->Tag		= (NativeInt)&BgImgHideScr;
	ShowPopDirBtnCheckBox->Tag	= (NativeInt)&ShowPopDirBtn;
	...
	ClickableUrlCheckBox->Tag	= (NativeInt)&ClickableUrl;
	RstViewLnCheckBox->Tag		= (NativeInt)&RestoreViewLine;
	ScrBarFoldCheckBox->Tag		= (NativeInt)&ScrBarToFoldPos;
	TvCsrVisiCheckBox->Tag		= (NativeInt)&TvCursorVisible;
	LimitBinCsrCheckBox->Tag	= (NativeInt)&LimitBinCsr;
	ColorHintCheckBox->Tag		= (NativeInt)&TxtColorHint;
	...
	EmRsvCheckBox->Tag			= (NativeInt)&EmpReserved;
	EmSymCheckBox->Tag			= (NativeInt)&EmpSymbol;
	EmNumCheckBox->Tag			= (NativeInt)&EmpNumeric;
	EmHdlnCheckBox->Tag 		= (NativeInt)&EmpHeadline;
	EmRubyCheckBox->Tag 		= (NativeInt)&EmpRuby;
	InsHrSctCheckBox->Tag		= (NativeInt)&HtmInsHrSct;
	InsHrArtCheckBox->Tag		= (NativeInt)&HtmInsHrArt;
	InsHrNavCheckBox->Tag		= (NativeInt)&HtmInsHrNav;
	MarkdownCheckBox->Tag		= (NativeInt)&ToMarkdown;
	RotViewImgCheckBox->Tag 	= (NativeInt)&RotViewImg;
	KeepZoomCheckBox->Tag		= (NativeInt)&KeepZoomRatio;
	ThumbNameCheckBox->Tag		= (NativeInt)&ShowThumbName;
	ThumbExifCheckBox->Tag		= (NativeInt)&ShowThumbExif;
	ThumbTagCheckBox->Tag		= (NativeInt)&ShowThumbTags;
	ThumbFExtCheckBox->Tag		= (NativeInt)&ShowThumbFExt;
	NotThumbIfArcCheckBox->Tag	= (NativeInt)&NotThumbIfArc;
	CacheThumbADSCheckBox->Tag	= (NativeInt)&CacheThumbADS;
	LoopCurCheckBox->Tag		= (NativeInt)&LoopViewCursor;
	HintTopEndCheckBox->Tag 	= (NativeInt)&HintTopEndImg;
	BeepTopEndCheckBox->Tag 	= (NativeInt)&BeepTopEndImg;
	ImgSttIsBtmCheckBox->Tag	= (NativeInt)&ImgSttIsBottom;
	ToolBarISideCheckBox->Tag	= (NativeInt)&ToolBarISide;
	SeekBindDirCheckBox->Tag	= (NativeInt)&SeekBindDir;
	SeekSwapNPCheckBox->Tag 	= (NativeInt)&SeekSwapNxtPrv;
	HideCsrFullCheckBox->Tag	= (NativeInt)&HideCsrInFull;
	HideThumbCheckBox->Tag		= (NativeInt)&HideThumbInFull;
	AnimateGifCheckBox->Tag 	= (NativeInt)&AnimateGif;
	ThumbScrCheckBox->Tag		= (NativeInt)&ShowThumbScroll;
	MarkImgCheckBox->Tag		= (NativeInt)&MarkImgClose;
	SureCopyCheckBox->Tag		= (NativeInt)&SureCopy;
	SureMoveCheckBox->Tag		= (NativeInt)&SureMove;
	SureDeleteCheckBox->Tag 	= (NativeInt)&SureDelete;
	SureUnPackCheckBox->Tag 	= (NativeInt)&SureUnPack;
	SureExecCheckBox->Tag		= (NativeInt)&SureExec;
	SureOtherCheckBox->Tag		= (NativeInt)&SureOther;
	SureExitCheckBox->Tag		= (NativeInt)&SureExit;
	SureCmpDelCheckBox->Tag 	= (NativeInt)&SureCmpDel;
	SureWorkListCheckBox->Tag 	= (NativeInt)&SureWorkList;
	SureCancelCheckBox->Tag 	= (NativeInt)&SureCancel;
	SureDefNoCheckBox->Tag		= (NativeInt)&SureDefNo;
	SureAdjPosCheckBox->Tag 	= (NativeInt)&SureAdjPos;
	WarnPowFailCheckBox->Tag	= (NativeInt)&WarnPowerFail;
	WarnLowBatheckBox->Tag		= (NativeInt)&WarnLowBattery;
	WarnDisconCheckBox->Tag 	= (NativeInt)&WarnDisconnect;
	PrtSubCheckBox->Tag 		= (NativeInt)&ProtectSubDir;
	PrtFileCheckBox->Tag		= (NativeInt)&ProtectFile;
	ImgEditSglCheckBox->Tag 	= (NativeInt)&ImageEditSgl;

	AppMinCheckBox->Tag			= (NativeInt)&AppListChgMin;
	OpenDirByStdCheckBox->Tag	= (NativeInt)&OpenDirByStd;
	OpenOnlyCurEditCheckBox->Tag= (NativeInt)&OpenOnlyCurEdit;
	DontClrSelEditCheckBox->Tag	= (NativeInt)&DontClrSelEdit;
	OpenOnlyCurAppCheckBox->Tag	= (NativeInt)&OpenOnlyCurApp;
	DontClrSelAppCheckBox->Tag 	= (NativeInt)&DontClrSelApp;
	OpenOnlyCurWinCheckBox->Tag = (NativeInt)&OpenOnlyCurWin;
	DontClrSelWinCheckBox->Tag 	= (NativeInt)&DontClrSelWin;
	...
	IncSeaFuzzyCheckBox->Tag	= (NativeInt)&IncSeaFuzzy;
	IncSeaLoopCheckBox->Tag 	= (NativeInt)&IncSeaLoop;
	IncSea1ExitCheckBox->Tag	= (NativeInt)&IncSeaMatch1Exit;
	IniPathToTab1CheckBox->Tag	= (NativeInt)&IniPathToTab1;
	IniTabHomeAllCheckBox->Tag	= (NativeInt)&IniTabHomeAll;
	SplashCheckBox->Tag 		= (NativeInt)&ShowSplash;
	FixWinCheckBox->Tag 		= (NativeInt)&FixWinPos;
	IniSeaByNumCheckBox->Tag	= (NativeInt)&IniSeaByNum;
	IniSeaBySignCheckBox->Tag	= (NativeInt)&IniSeaBySign;
	MulInstCheckBox->Tag		= (NativeInt)&MultiInstance;
	CloseOtherCheckBox->Tag 	= (NativeInt)&CloseOthers;
	TaskTrayCheckBox->Tag		= (NativeInt)&StoreTaskTray;
	FindPathColCheckBox->Tag	= (NativeInt)&FindPathColumn;
	FindTagsColCheckBox->Tag	= (NativeInt)&FindTagsColumn;
	FindTagsSortCheckBox->Tag	= (NativeInt)&usr_TAG->SortTags;

	//UnicodeString (Style = csDropDown)
	L_IniMaskComboBox->Tag		= (NativeInt)&InitialMask[0];
	R_IniMaskComboBox->Tag		= (NativeInt)&InitialMask[1];
	WheelCmdF0ComboBox->Tag 	= (NativeInt)&WheelCmdF[0];
	WheelCmdF1ComboBox->Tag 	= (NativeInt)&WheelCmdF[1];
	WheelCmdF2ComboBox->Tag 	= (NativeInt)&WheelCmdF[2];
	WheelCmdF3ComboBox->Tag 	= (NativeInt)&WheelCmdF[3];
	WheelCmdV0ComboBox->Tag 	= (NativeInt)&WheelCmdV[0];
	WheelCmdV1ComboBox->Tag 	= (NativeInt)&WheelCmdV[1];
	WheelCmdV2ComboBox->Tag 	= (NativeInt)&WheelCmdV[2];
	WheelCmdV3ComboBox->Tag 	= (NativeInt)&WheelCmdV[3];
	WheelCmdI0ComboBox->Tag 	= (NativeInt)&WheelCmdI[0];
	WheelCmdI1ComboBox->Tag 	= (NativeInt)&WheelCmdI[1];
	WheelCmdI2ComboBox->Tag 	= (NativeInt)&WheelCmdI[2];
	WheelCmdI3ComboBox->Tag 	= (NativeInt)&WheelCmdI[3];
	WheelBtnF0ComboBox->Tag 	= (NativeInt)&WheelBtnCmdF[0];
	WheelBtnF1ComboBox->Tag 	= (NativeInt)&WheelBtnCmdF[1];
	WheelBtnF2ComboBox->Tag 	= (NativeInt)&WheelBtnCmdF[2];
	WheelBtnF3ComboBox->Tag 	= (NativeInt)&WheelBtnCmdF[3];
	WheelBtnVComboBox->Tag		= (NativeInt)&WheelBtnCmdV;
	WheelBtnIComboBox->Tag		= (NativeInt)&WheelBtnCmdI;
	X1BtnFComboBox->Tag 		= (NativeInt)&X1BtnCmdF;
	X2BtnFComboBox->Tag 		= (NativeInt)&X2BtnCmdF;
	X1BtnVComboBox->Tag 		= (NativeInt)&X1BtnCmdV;
	X2BtnVComboBox->Tag 		= (NativeInt)&X2BtnCmdV;
	X1BtnIComboBox->Tag 		= (NativeInt)&X1BtnCmdI;
	X2BtnIComboBox->Tag 		= (NativeInt)&X2BtnCmdI;

	//int (Style = csDropDownList)
	LayoutComboBox->Tag 		= (NativeInt)&LayoutMode;
	SizeFmtComboBox->Tag		= (NativeInt)&SizeFormatMode;
	TabStyleComboBox->Tag		= (NativeInt)&FlTabStyle;
	ScrBarStyleComboBox->Tag	= (NativeInt)&ScrBarStyle;
	BgImgModeComboBox->Tag		= (NativeInt)&BgImgMode;
	BgImgSubModeComboBox->Tag	= (NativeInt)&BgImgSubMode;

	ScaleOptComboBox->Tag		= (NativeInt)&WicScaleOpt;
	ThumbOptComboBox->Tag		= (NativeInt)&ThumbScaleOpt;
	OpenByModeComboBox->Tag 	= (NativeInt)&OpenByMode;
	DblClickFlComboBox->Tag 	= (NativeInt)&DblClickFlMode;
	DefDropComboBox->Tag		= (NativeInt)&DefDropMode;
	SizeDecDgtComboBox->Tag 	= (NativeInt)&SizeDecDigits;

	IniModeIRadioGroup->Tag 	= (NativeInt)&InitialModeI;
	L_IniSortRadioGroup->Tag	= (NativeInt)&IniSortMode[0];
	R_IniSortRadioGroup->Tag	= (NativeInt)&IniSortMode[1];

	PrtDirRadioGroup->Tag		= (NativeInt)&ProtectDirMode;

	KeybdRadioGroup->Tag		= (NativeInt)&KeyboardMode;
...
void __fastcall TOptionDlg::FormShow(TObject *Sender)
{
	...
	slst->Sort();
	VclStyleComboBox->Items->Assign(slst.get());
	...
	const TRect &Rect, bool Active)
{
	...
	if (tp->TabHeight>0 && tp->TabHeight<=4) {
		...
		if (use_VclStyle() && !Active) {
			...
			cv->MoveTo(Rect.Left, Rect.Bottom);
			cv->LineTo(Rect.Left, Rect.Top);
	...
	TRect &Rect, TOwnerDrawState State)
{
	...
	if (!starts_Dollar(etc_edtr) || contains_PathDlmtr(etc_edtr)) {
		...
		if (file_exists(etc_fnam))
			draw_SmallIconF(etc_fnam, cv, xp, Rect.Top + (Rect.Height() - SCALED_THIS(16))/2, this);
		else
	...
	const TRect &ARect, TOwnerDrawState State)
{
	...
	ACanvas->Brush->Color = TStyleManager::ActiveStyle->GetSystemColor(is_hl? clMenuHighlight : clMenu);
	ACanvas->Font->Color  = TStyleManager::ActiveStyle->GetSystemColor(
	...
	TRect &Rect, TOwnerDrawState State)
{
	...
	//関連付け
		...
		if (file_exists(fnam)) draw_SmallIconF(fnam, cv, xp, Rect.Top + (Rect.Height() - SCALED_THIS(16))/2, this);
		xp += SCALED_THIS(20);
	...
	TRect &Rect, TOwnerDrawState State)
{
	...
	int xp = Rect.Left + SCALED_THIS(2) + SCALED_THIS(18) + (sub_lvl * cv->TextWidth("W"));
	int yp = Rect.Top + (Rect.Height() - cv->TextHeight("Q"))/2;
...
void __fastcall TOptionDlg::ExtHeaderDrawSection(THeaderControl *HeaderControl,
	THeaderSection *Section, const TRect &Rect, bool Pressed)
{
	draw_SortHeader(HeaderControl, Section, Rect, 0, true);
}
...
void __fastcall TOptionDlg::OkActionExecute(TObject *Sender)
{
	...
	if (IsPrimary) {
		...
		if (!SameText(AppListHotKey, kstr)) {
...
void __fastcall TOptionDlg::OkActionUpdate(TObject *Sender)
{
	...
	set_EditColor(DirBraEdit, ShowIconCheckBox->Checked);
	set_EditColor(DirKetEdit, ShowIconCheckBox->Checked);

	bool flag = (DlgMoveShiftCheckBox->Checked || DlgMoveCtrlCheckBox->Checked || DlgMoveAltCheckBox->Checked);
	DlgMoveLabel->Font->Color = get_LabelColor(!flag);
	set_EditColor(DlgMoveEdit, !flag);

	flag = (DlgSizeShiftCheckBox->Checked ||DlgSizeCtrlCheckBox->Checked || DlgSizeAltCheckBox->Checked);
	DlgSizeLabel->Font->Color = get_LabelColor(!flag);
	set_EditColor(DlgSizeEdit, !flag);
	...
	set_EditColor(PrvTxtInfLnEdit, !PrevTxtToInfCheckBox->Checked);

	PrevTailCheckBox->Enabled	  = PrevTxtToInfCheckBox->Checked;
	flag = (PrevTxtToInfCheckBox->Checked && PrevTailCheckBox->Checked);
	set_EditColor(PrvTxtTailLnEdit, !flag);
	set_EditColor(PrvActTailLnEdit, !flag);

	set_EditColor(InfPrvWaitEdit, EditToInt(InfPrvWaitEdit)==0);
	...
	set_EditColor(FwCntWarnEdit, flag);
	set_EditColor(FwTmWarnEdit,  flag);

	flag = (EditToInt(FwCntTaskFinEdit)==0 || EditToInt(FwTmTaskFinEdit)==0);
	set_EditColor(FwCntTaskFinEdit, flag);
	set_EditColor(FwTmTaskFinEdit,  flag);
	...
	set_EditColor(ListPercentEdit, !KeepOnResizeCheckBox->Checked);
	set_EditColor(FindPathWdEdit,  !FindPathColCheckBox->Checked);
	set_EditColor(FindTagsWdEdit,  !FindTagsColCheckBox->Enabled || !FindTagsColCheckBox->Checked);

	set_EditColor(ModalAlphaEdit,  !ModalScrCheckBox->Checked);
	...
	set_EditColor(BgImg1Edit, bgmod==0 || bgmod==3);
	set_EditColor(BgImg2Edit, bgmod!=2);
	set_EditColor(HideTimeEdit, !HideScrCheckBox->Checked);
	set_EditColor(TileIfSzEdit, !TileIfCheckBox->Checked);
	...
	set_EditColor(MarkPathEdit, !MarkImgCheckBox->Checked);
	set_EditColor(MarkFextEdit, !MarkImgCheckBox->Checked);
	set_EditColor(MarkMemoEdit, !MarkImgCheckBox->Checked);

	set_EditColor(ViewTabXEdit, EditToInt(TabXWdEdit)==0);

	set_EditColor(L_IniPatEdit, !L_IniPatMod2RadioBtn->Checked);
	set_EditColor(R_IniPatEdit, !R_IniPatMod2RadioBtn->Checked);
}
