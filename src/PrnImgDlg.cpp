...
void __fastcall TPrintImgDlg::FormShow(TObject *Sender)
{
	...
	PrviewPanel->Color		 = TStyleManager::ActiveStyle->GetSystemColor(clAppWorkSpace);
	SizeLabel->Color		 = TStyleManager::ActiveStyle->GetSystemColor(clAppWorkSpace);
	SizeLabel->Font->Color	 = TStyleManager::ActiveStyle->GetSystemColor(clWindowText);
