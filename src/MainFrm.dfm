object NyanFiForm: TNyanFiForm
        ...
        object GrepMidPanel: TPanel
          ...
          object GrepM1Panel: TPanel
            ...
            object GrepM1sPanel: TPanel
              ...
              TabOrder = 4
              Visible = False
              object GrepSelInfPaintBox: TPaintBox
                Left = 8
                Top = 6
                Width = 105
                Height = 22
                OnPaint = GrepSelInfPaintBoxPaint
              end
            end
            ...
            object SubDirNEdit: TLabeledEdit
              Left = 298
              Top = 4
              Width = 40
              Height = 23
              ...
              EditLabel.Width = 22
              EditLabel.Height = 23
              EditLabel.Caption = #28145#12373
              LabelPosition = lpLeft
              TabOrder = 2
              Text = '0'
            end
            object SubDirNUpDown: TUpDown
              Left = 338
              Top = 4
              Width = 16
              Height = 23
              Anchors = [akTop, akRight]
              Associate = SubDirNEdit
              Max = 99
              TabOrder = 3
            end
          end
  ...
  object ActionList1: TActionList
    ...
    object LockKeyMouseAction: TAction
      Category = 'Command'
      OnExecute = LockKeyMouseActionExecute
      OnUpdate = MenuFVIActionUpdate
    end
    ...
    object FKeyRenameAction: TAction
      Category = 'Menu'
      Caption = #34920#31034#21517#12398#22793#26356'(&R)...'
      OnExecute = FKeyRenameActionExecute
    end
  ...
  object MainMenu1: TMainMenu
    ...
    object ViewMenuV: TMenuItem
      Caption = #34920#31034'(&V)'
      OnClick = MainMenuClick
      object ReternListItemV: TMenuItem
        Action = ReturnListAction
      end
      object Sep_vt_1: TMenuItem
        Caption = '-'
      end
      object ShowToolBarItemV: TMenuItem
        Action = ShowToolBarAction
      end
      object ShowFkeyBarItemV: TMenuItem
        Action = ShowFKeyBarAction
      end
      object ShowSttBarItemV: TMenuItem
        Action = ShowStatusBarAction
      end
    ...
    object ViewMenuI: TMenuItem
      Caption = #34920#31034'(&V)'
      OnClick = MainMenuClick
      object ReternListItemI: TMenuItem
        Action = ReturnListAction
      end
      object Sep_vi_1: TMenuItem
        Caption = '-'
      end
      object ShowToolBarItemI: TMenuItem
        Action = ShowToolBarAction
      end
      object ShowFkeyBarItemI: TMenuItem
        Action = ShowFKeyBarAction
      end
      object ShowSttBarItemI: TMenuItem
        Action = ShowStatusBarAction
      end
      object ShowSeekBarItem: TMenuItem
        Action = ShowSeekBarAction
      end
      object Sep_vi_2: TMenuItem
        Caption = '-'
      end
