...
__published:	// IDE で管理されるコンポーネント
	...
	TMenuItem *ReternListItemI;
	TMenuItem *ReternListItemV;
	...
	TMenuItem *ShowFkeyBarItemI;
	TMenuItem *ShowFkeyBarItemV;
	...
	TMenuItem *ShowSttBarItemI;
	TMenuItem *ShowSttBarItemV;
	TMenuItem *ShowTabBarItem;
	TMenuItem *ShowTabItem;
	TMenuItem *ShowToolBarItem;
	TMenuItem *ShowToolBarItemI;
	TMenuItem *ShowToolBarItemV;
	...
	void __fastcall FKeyRenameActionExecute(TObject *Sender);
	...
	void __fastcall DirSttPanelClick(TObject *Sender);
